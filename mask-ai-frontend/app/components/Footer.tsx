  ...
  return (
    <footer className={styles.footer}>
      <div className={styles.container} suppressHydrationWarning>
        <div className={styles.mainText} suppressHydrationWarning>
          © {currentYear} <strong>MaskGuard AI</strong> – Phát Hiện Khẩu Trang Thông Minh
        </div>
        ...
        <div className={styles.madeWith} suppressHydrationWarning>
          Made with <span>Next.js 16</span> + <span>FastAPI</span> + <span>TensorFlow</span>
        </div>
      </div>
    </footer>
  );
